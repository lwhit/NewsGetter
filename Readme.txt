...
Unfortunately, could not make this happen. I was still able to provide user
feedback though by displaying different websites depending on the actions
of the program. 

Running instructions: Open project in XCode and run with simulator. I ran it
using an iPhone 6 simulator, the display has constraints though so it should
display properly in any setting. 
